...
@EnableJpaRepositories(
		basePackages = "com.example.springbootmultipledatasource.springbootmultipledatasource.repository.student",
...
public class StudentRepositoryConfig {
	...
	public DataSource studentDataSource() {
		return studentDataSourceProperties().initializeDataSourceBuilder().type(BasicDataSource.class).build();
	}
	...
	@Primary
	public PlatformTransactionManager studentTransactionManager(@Qualifier("studentEntityManager") LocalContainerEntityManagerFactoryBean entityManagerFactoryBean) {
